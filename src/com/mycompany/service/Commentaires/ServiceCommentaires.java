...
public class ServiceCommentaires {
    ...
    public void updateCommentaire(Commentaires rcl) {
        ConnectionRequest con = new ConnectionRequest();
        System.out.println(rcl.toString());
        String url = "http://localhost/PiDevWeb/web/app_dev.php/ModificationDeCommentaire/"+rcl.getIdCommentaire();
    ...
    public void deleteCommentaire(Commentaires rcl) {
        ConnectionRequest con = new ConnectionRequest();
        System.out.println(rcl.toString());
        String url = "http://localhost/PiDevWeb/web/app_dev.php/SuppressionDeCommentaire/"+rcl.getIdCommentaire();
        con.setUrl(url);
...
//                System.out.println(e);
    ...
    public ArrayList<Commentaires> getListeComments(){       
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://localhost/PiDevWeb/web/app_dev.php/AffichageDeCommentaire");        
        con.setPost(false);

...
public class ServiceReclamations {
    ...
    public void newReclamation(Reclamations rcl) {
        ...
        String url = "http://"+Util.addip+"/pidevwebservice/web/app_dev.php/envoieReclamations";
...
//        System.out.println(listEtudiants);
    ...
    public ArrayList<Reclamations> getListeFinale(){       
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://"+Util.addip+"/pidevwebservice/web/app_dev.php/consulterReclamationsClients");
        con.setPost(false);
    ...
    public ArrayList<Magasins> getListeMagasin(){       
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://"+Util.addip+"/pidevwebservice/web/app_dev.php/listeMagasins");        
        con.setPost(false);
        con.addResponseListener((NetworkEvent evt) -> {
            ServiceReclamations ser = new ServiceReclamations();
            try {
    ...
    public void updateReclamation(Reclamations rcl) {
        ...
        con.setPost(false);
        System.out.println(rcl.toString());
        String url = "http://"+Util.addip+"/pidevwebservice/web/app_dev.php/editReclamation/"+rcl.getIdReclamation();
...
//        System.out.println(listEtudiants);
    ...
    public ArrayList<Reclamations> getListeFinale2(){       
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://"+Util.addip+"/pidevwebservice/web/app_dev.php/consulterReclamationsVendeur");        
        con.setPost(false);
        con.addArgument("id", String.valueOf(Util.connectedUser.getId()));
        con.addResponseListener((NetworkEvent evt) -> {
            ServiceReclamations ser = new ServiceReclamations();
    ...
    public ArrayList<Reclamations> getListeFinale3(){       
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://"+Util.addip+"/pidevwebservice/web/app_dev.php/consulterReclamationsVendeur2");        
        con.setPost(false);
        con.addArgument("id", String.valueOf(Util.connectedUser.getId()));
        con.addResponseListener((NetworkEvent evt) -> {
            ServiceReclamations ser = new ServiceReclamations();
    ...
    public ArrayList<Statisques> showStats(){       
        ConnectionRequest con = new ConnectionRequest();
        con.setUrl("http://"+Util.addip+"/pidevwebservice/web/app_dev.php/consulterReclamationsStats");        
        con.setPost(false);
        con.addArgument("id", String.valueOf(Util.connectedUser.getId()));
        con.addResponseListener((NetworkEvent evt) -> {
            ServiceReclamations ser = new ServiceReclamations();

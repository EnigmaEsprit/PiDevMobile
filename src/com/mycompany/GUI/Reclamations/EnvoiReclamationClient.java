...
public class EnvoiReclamationClient {
    ...
    public EnvoiReclamationClient() {
        ...
        ToolbarForm tbf = new ToolbarForm();
            ...
            tbf.Menu(envoiReclamation); 
        }
             
                else{
             
            tbf.Menu0(envoiReclamation); 
        }
       envoiReclamation.getToolbar().addCommandToOverflowMenu("LogOut", null, new ActionListener() {
                                @Override
...
//                mags.getStyle().setBgTransparency(255);
        ...
        btnEnvoi.addActionListener((evt3) -> {
            if(typReclamation.getSelectedItem().equals("-- Sélectionner le type de réclamation --"))
                ...
                r.setIdUser(Util.connectedUser);

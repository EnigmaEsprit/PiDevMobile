...
public class ConsulterReclamationsVendeur {
   ...
   if(User.getActifUser() !=null && User.getActifUser().getRoles().equalsIgnoreCase("[ROLE_USER]")){
    ...
    consulterReclamations.getToolbar().addCommandToOverflowMenu("Stats", null, new ActionListener() {
                                @Override
                                public void actionPerformed(ActionEvent evt) {
                                    
                                    
                                    StatsReclamation h = new StatsReclamation();
                                    h.createPieChartForm().show();
                                }
                            });
    consulterReclamations.getToolbar().addCommandToOverflowMenu("LogOut", null, new ActionListener() {
                                @Override
                                public void actionPerformed(ActionEvent evt) {
